...
def get_args():
    ...
    parser.add_argument('--img_path', type=str, default=r"/mnt/data1/zc_data/peidianfang/peidianfang_1222/dlqkg/images/val/",help="the images Path of your dataset, eg: /home/yourPath/Images")
    parser.add_argument('--mode', type=str, default="VOC2YOLO",
    ...
    parser.add_argument('--label_path', type=str, default=r"/mnt/data1/zc_data/peidianfang/peidianfang_1222/dlqkg/labels/val/",help="the labels Path of your dataset, eg: /home/yourPath/Labels , \
                                                    if your original data is COCO type, this argument should be the \
                                                    json file name, eg: /home/yourPath/label.json ")
    parser.add_argument('--save_path', type=str, default=r"/mnt/data1/zc_data/peidianfang/peidianfang_1222/dlqkg/xml_labels/val",
