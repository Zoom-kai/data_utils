...
def get_args():
    ...
    parser.add_argument('--img_path', type=str, default="/mnt/data1/zc_data/tswitch/GIS2_cls3/jingsai_gis/images/val/",help="the images Path of your dataset, eg: /home/yourPath/Images")
    parser.add_argument('--mode', type=str, default="LabelView_VOC",
    ...
    parser.add_argument('--label_path', type=str, default="/mnt/data1/zc_data/tswitch/GIS2_cls3/jingsai_gis/labels/val_xml/",help="the labels Path of your dataset, eg: /home/yourPath/Labels , \
                                                    if your original data is COCO type, this argument should be the \
                                                    json file name, eg: /home/yourPath/label.json ")
    parser.add_argument('--save_path', type=str, default="/mnt/data1/zc_data/tswitch/GIS2_cls3/jingsai_gis_xml_view/",
