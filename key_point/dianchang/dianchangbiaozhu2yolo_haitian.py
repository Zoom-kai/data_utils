...
if __name__ == '__main__':
    ...
    labelme_json_path = "/mnt/data1/zc_data/dianchang/dianchang_7yue_dk/data_haitian/json_labels"

    img_path = "/mnt/data1/zc_data/dianchang/dianchang_7yue_dk/data_haitian/images"

    out_label_yolo = "/mnt/data1/zc_data/dianchang/dianchang_7yue_dk/data_haitian/labels_weilan"
    ...
    # out_classes = ['Fall_arrester', 'Handheld_items', 'hand']
    # out_classes = ['Fall_arrester', 'Handheld_items', 'hand']
    out_classes = ['15', '16', '17', '18']

    # yiranwupin
    # out_classes = ['19', '20', '21', '22', '23', '24', '25', '26', '27']

    # 工装
    # out_classes = ['0']

    # haitian
    # out_classes = ['0', '1', '2', '3', '4', '5', '6']

    # jinglianwen
    # out_classes = ['人', '安全帽', '无安全帽', '安全带', '无安全带', '工装', '无工装']

    # 根据场景分类，需要输出的label类别

    # out_classes = ["enclosure"]
