...
def convert_annotation(class_list, xml_path, save_path):
    ...
    num6 = 0
    num7 = 0
    save_dir = "/mnt/data1/zc_data/da_model_merge/duoyude"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--xml_path', type=str, default=r"/mnt/data1/zc_data/fire_flash_yolo/fire_voc_2012/fireData/xml_labels", help='images dir')
    parser.add_argument('--txt_path', type=str, default=r"/mnt/data1/zc_data/fire_flash_yolo/fire_voc_2012/fireData/yolo_labels", help='xml files dir')
