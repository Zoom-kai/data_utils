...
def load_model(model, resume_dataset=None, best_miou=False, is_cuda=False, gpu_ids=None, weights=None):
    ...
    if resume_dataset is not None:
        ...
        print(resume_dataset, checkpoint_name)
        print(1111111111111, weights)
        checkpoint_path = os.path.join(weights)
        # checkpoint_path = os.path.join("/mnt/data1/zc_data/model_weights/deeplabv3/weights/deeplab-resnet/weight_epoch28",
        #                                checkpoint_name)
