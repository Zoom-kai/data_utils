...
img_path = r"/mnt/data1/zc_data/map_data/china_90_city_datasets/simplified_Version_1/Tier2/Nanjing/dataset/images_png"

mask_path = r"/mnt/data1/zc_data/map_data/china_90_city_datasets/simplified_Version_1/Tier2/Nanjing/dataset/masks_png"
add_save_path = r"/mnt/data1/zc_data/map_data/china_90_city_datasets/simplified_Version_1/Tier2/Nanjing/dataset/images_add"
...
for img_name in img_list:
    ...
    img = cv2.imread("{}/{}".format(img_path, img_name.replace("png", "tif")))
