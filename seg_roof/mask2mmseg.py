...
def convert_mask(mask_path, img_path, label, mask_save_path, npy_img_save_path, name):
    ...
    for mask_name in tqdm(mask_list):
        if num % 1 == 0:
            ...
            # mask[mask != 255] = 0
            print(mask, mask[mask!=0])
            # exit()
            mask[mask != 0 ] = 1
            # print(mask)
            # mask = np.expand_dims(mask, 2)
            # mask_l = np.concatenate((mask, mask, mask), 2)
            # print(mask_l)
            # print(mask_l.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_path', type=str, default="/mnt/data1/zc_data/map_data/train_180k_old_map/masks_guolv/val", help='images dir')
    parser.add_argument('--img_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_data/images/val", help='coco type dataset save dir')
    ...
    parser.add_argument('--npy_img_save_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_data/images",
                        help='coco type dataset save dir')
    parser.add_argument('--npy_mask_save_path', type=str, default="/mnt/data1/zc_data/map_data/train_180k_old_map/masks_guolv/val_1",
                        help='coco type dataset save dir')
