...
def figure_num(img):
    ...
    v = (canny_dst[canny_dst>0].sum())/(img.shape[0]*img.shape[1])
    ...
    edge_points,h=cv2.findContours(canny_dst, cv2.RETR_LIST, cv2.CHAIN_APPROX_NONE)
