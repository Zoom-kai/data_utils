...
if __name__ == '__main__':
    ...
    parser.add_argument('--mask_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_merge/ori_ditu/tianditu_data4_1101/masks_patch", help='images dir')
    parser.add_argument('--img_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_merge/ori_ditu/tianditu_data4_1101/images_patch", help='coco type dataset save dir')
    ...
    parser.add_argument('--img_save_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_merge/ori_ditu/tianditu_data4_1101/images",
                        help='coco type dataset save dir')
    parser.add_argument('--mask_save_path', type=str, default="/mnt/data1/zc_data/map_data/tianditu_merge/ori_ditu/tianditu_data4_1101/masks",
                        help='coco type dataset save dir')
